...
## 分工元原则 · 2026-07-09 20:30 立(天蓝主动看表的前提)

**核心事实**: 天蓝每天主动看飞书表 · AI 只负责"抓" · 不负责"填全"

**含义**:
- 飞书识别信息不全时 · 填知道的 · 剩下留空 · 不 4 选 1 卡流程
- GitHub Claude 不用兜底做识别(除非天蓝主动要)
- AI 不要"追求精准送到天蓝面前"· 天蓝自己会补

**反模式**:
- 4 选 1 追问天蓝 · 让她审 4 遍
- GitHub Claude 主动介入工作类待办识别(违反 A 方案)
- 为"字段全"起复杂识别规范

**正模式**:
- 有 60% 信息就先加 record · 留空字段
- 天蓝审时补 40%
- 保持简单流程 · 不为完美卡住
